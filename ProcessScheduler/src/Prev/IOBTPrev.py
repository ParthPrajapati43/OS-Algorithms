...
def prevIOBT(self):    
    ...
    if(self.currTimer == 1):
        if(str(self.AlgoSelector.currentText()) == "FCFS"):
            self.solveFCFSIO()
        if(str(self.AlgoSelector.currentText()) == "SJF"):
            self.solveSJFIO()
        if(str(self.AlgoSelector.currentText()) == "SRTF"):
            self.solveSRTFIO()
        if(str(self.AlgoSelector.currentText()) == "RR"):
            self.solveRRIO()
        if(str(self.AlgoSelector.currentText()) == "LJF"):
            self.solveLJFIO()
        if(str(self.AlgoSelector.currentText()) == "LRTF"):
            self.solveLRTFIO()
        if(str(self.AlgoSelector.currentText()) == "Priority"):
            self.solvePriorityIO()
        
        # set gantt chart blank
