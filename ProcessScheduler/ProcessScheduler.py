...
class Ui_MainWindow(object):
    ...
    rgbRed = [255, 163, 111, 111, 250, 255, 165, 165, 1, 255, 212, 157, 126, 212, 192, 115, 245, 220, 187, 231, 255, 198, 127,
            188, 241, 16, 16, 200, 255, 255, 128, 96, 255, 0, 255, 255, 0, 189, 111, 230, 4, 42, 4, 255, 105, 255, 168, 229, 22, 114]
    rgbGreen = [129, 129, 253, 244, 255, 165, 255, 165, 250, 227, 126, 126, 212, 126, 160, 213, 184, 187, 187, 255, 193, 72, 179,
                250, 197, 136, 255, 255, 216, 72, 16, 230, 246, 221, 187, 42, 255, 189, 109, 4, 230, 230, 170, 50, 255, 201, 188, 217, 206, 22]
    rgbBlue = [129, 255, 121, 253, 81, 241, 201, 255, 151, 80, 198, 212, 163, 126, 191, 100, 80, 219, 220, 189, 34, 89, 171,
            181, 246, 255, 160, 16, 16, 16, 255, 177, 0, 255, 0, 0, 8, 79, 155, 223, 140, 4, 230, 77, 50, 50, 189, 52, 59, 206]
    colorHexCode = ["#ff8181", "#a381ff", "#6ffd6f", "#6dd4fd", "#faff51", "#ffa5f1", "#a5ffc9", "#a5a5ff", "#01fa97", "#ffe350", "#d47ec6", "#9d7ed4", "#7ed4a3", "#d47e7e", "#c0a0bf", "#73d564", "#f5b850", "#dcbbdb", "#bbbbdc", "#e7ffbd", "#e1c122", "#c64859", "#7fb3ab", "#bcfab5",
                    "#f1c5f6", "#1088ff", "#10ffa0", "#c8ff10", "#ffd810", "#ff4810", "#8010ff", "#60e6b1", "#fff600", "#00ddff", "#ffbb00", "#ff2a00", "#00ff08", "#bdbd4f", "#6f6d9b", "#e604df", "#04e68c", "#2ae604", "#04aae6", "#ff324d", "#69ff32", "#ffc932", "#a8bcbd", "#e5d934", "#16ce3b", "#7216ce"]
    ...
    # Get/Set
    from src.GetSet.Get import getPriorityList, getATList, getBTList, getIOBTList, getBT2List, getPercList, getStateList
    from src.GetSet.Set import setCTlist, setTATlist, setWTlist, setRTlist, setPerclist, setStatelist, setNonEditableColumns, setWidgetsInCellsAndAlign
    
    # Next
    from src.Next.NotIOBTNext import nextNotIOBT
    from src.Next.IOBTNext import nextIOBT
    
    # Prev
    from src.Prev.NotIOBTPrev import prevNotIOBT
    from src.Prev.IOBTPrev import prevIOBT
    
    # Solve
    from src.Solve.FCFSSolve import solveFCFS
    from src.Solve.FCFSIOSolve import solveFCFSIO
    from src.Solve.SJFSolve import solveSJF
    from src.Solve.SJFIOSolve import solveSJFIO
    from src.Solve.SRTFSolve import solveSRTF
    from src.Solve.SRTFIOSolve import solveSRTFIO
    from src.Solve.RRSolve import solveRR
    from src.Solve.RRIOSolve import solveRRIO
    from src.Solve.LJFSolve import solveLJF
    from src.Solve.LJFIOSolve import solveLJFIO
    from src.Solve.LRTFSolve import solveLRTF
    from src.Solve.LRTFIOSolve import solveLRTFIO
    from src.Solve.PrioritySolve import solvePriority
    from src.Solve.PriorityIOSolve import solvePriorityIO
    from src.Solve.PriorityIOSolveNP import solvePriorityIONP

    # Buttons
    from src.Buttons.Go import goBtnHandler
    from src.Buttons.Reset import resetBtnHandler
    from src.Buttons.Change import GCchangeBtnHandler
    from src.Buttons.Solve import solveBtnHandler 
    from src.Buttons.Next import nextBtnHandler
    from src.Buttons.Prev import prevBtnHandler
    from src.Buttons.Play import playBtnHandler
    from src.Buttons.Pause import pauseBtnHandler
    from src.Buttons.Plot import graphBtnHandler
    from src.Buttons.Import import importBtnHandler
    from src.Buttons.Download import downloadBtnHandler
    from src.Buttons.Help import helpBtnHandler
    ...
    def setupUi(self, MainWindow):
        ...
        self.AlgoInfoSetter.setStyleSheet("*{background: #232629}")
        ...
        self.JobtoReadyArrow.setPixmap(QtGui.QPixmap("images/JobtoReady.png"))
        ...
        self.ReadytoCPUArrow.setPixmap(QtGui.QPixmap("images/ReadytoCPU.png"))
        ...
        self.CPUtoTerminatedArrow.setPixmap(
            QtGui.QPixmap("images/CPUtoTerminated.png"))
        ...
        self.IOQueuetoIODeviceArrow.setPixmap(
            QtGui.QPixmap("images/IOQueuetoIODevice.png"))
        ...
        self.CPUtoIOQueueArrow.setPixmap(
            QtGui.QPixmap("images/CPUtoIOQueue.png"))
        ...
        self.CPUtoReadyArrow.setPixmap(QtGui.QPixmap("images/CPUtoReady.png"))
        ...
        self.IODevicetoReadyArrow.setPixmap(
            QtGui.QPixmap("images/IODevicetoReady.png"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "CPU"))
        self.GanttChartLabel.setText(_translate("MainWindow", "Gantt Chart (CPU)"))
        ...
        self.GCchangeBtn.setStyleSheet("*{\n"
                                   "background: #ffffff;\n"
                                   "font-size: 13px;\n"
                                   "}")
