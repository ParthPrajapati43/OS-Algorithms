...
class Ui_MainWindow(object):
    ...
    from src.Next.FCFSNext import nextFCFS
    from src.Prev.FCFSPrev import prevFCFS
    from src.Solve.SJFSolve import solveSJF
    from src.Next.SJFNext import nextSJF
    from src.Prev.SJFPrev import prevSJF
    from src.Solve.SRTFSolve import solveSRTF
    from src.Next.SRTFNext import nextSRTF
    from src.Prev.SRTFPrev import prevSRTF
    from src.Solve.RRSolve import solveRR
    from src.Next.RRNext import nextRR
    from src.Prev.RRPrev import prevRR
    from src.Solve.LJFSolve import solveLJF
    from src.Next.LJFNext import nextLJF
    from src.Prev.LJFPrev import prevLJF
    from src.Solve.LRTFSolve import solveLRTF
    from src.Next.LRTFNext import nextLRTF
    from src.Prev.LRTFPrev import prevLRTF
    from src.Solve.PrioritySolve import solvePriority
    from src.Next.PriorityNext import nextPriority
    from src.Prev.PriorityPrev import prevPriority
